...
public:
    typedef std::array<std::array<BaseBuilding *, gameconstants::mapWeight>, gameconstants::mapHeight> BuildingsArray;
    ...
    const std::vector<BaseBuilding *> &buildings() const;
    ...
    BaseBuilding *getByPos(int x, int y) const { return buildings_[x][y]; }
